...
class GameMain {
    ...
    onLoaded(): void {
        ...
        var score1: Laya.Sprite = new Laya.Sprite()
        var score2: Laya.Sprite = new Laya.Sprite()
    ...
    game_over(): void {
        ...
        var g_over: Laya.Sprite = new Laya.Sprite();
        var g_reset: Laya.Sprite = new Laya.Sprite();
